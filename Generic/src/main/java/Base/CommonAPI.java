...
public class CommonAPI {
    ...
    public String browserstack_username= "farhanahaque1";
    public String browserstack_accesskey = "B6RJfAvzqSwLXt6oFHyz";
   ...
   /* public WebDriver getLocalDriver(@Optional("OS X") String OS, String browserName){
        if(browserName.equalsIgnoreCase("chrome")){
            if(OS.equalsIgnoreCase("OS X")){
                System.setProperty("webdriver.chrome.driver","C:\\Users\\farha\\Desktop\\WebAutomationFrameWork2018\\Driver\\chromedriver"); //this one used
